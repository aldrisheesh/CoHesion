...
import { TrendingUp, CheckCircle2, Clock, Zap, Brain, Users, AlertCircle, Coffee, Target } from 'lucide-react';
...
export function HomeDashboard({ context }: HomeDashboardProps) {
  ...
  const stats = [
    { label: 'Tasks Completed', value: '12/18', icon: CheckCircle2, trend: '+3 today' },
    { label: 'Focus Time', value: '3.5h', icon: Clock, trend: '47 min current' },
    { label: 'Energy Level', value: '78%', icon: Zap, trend: 'Peak window' },
    { label: 'Team Sync', value: '4/6', icon: Users, trend: '2 available' },
  ];
      ...
      <div className="p-6 max-w-7xl mx-auto">
        ...
        >
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-white">Command Center</h1>
          </div>
          <p className="text-neutral-400">2 critical · 4h until EOD · High urgency mode active</p>
        </motion.div>
        ...
        <div className="grid grid-cols-3 gap-4">
          {/* Critical Tasks - Larger, Left Side */}
          <div className="col-span-2 space-y-3">
            <h2 className="text-white mb-3">Critical Tasks</h2>
          ...
          <div className="space-y-3">
            ...
            {[
              ...
              { icon: Brain, label: '2 decisions pending', type: 'urgent' },
              { icon: Users, label: 'Team blocked', type: 'warning' },
            ].map((alert, index) => {
  ...
  // Focus Mode Layout - Ultra Minimal
  if (mode === 'Focus') {
    return (
  ...
  // Chill Mode Layout - Spacious and Reflective
  return (
    <div className="p-12 max-w-6xl mx-auto">
      ...
      >
        <div className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-[var(--component-chip-default)] mb-4">
          ...
          <span className="text-[var(--text-primary)]">Relaxation Mode</span>
        </div>
      ...
      <div className="grid grid-cols-2 gap-8">
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-[var(--text-primary)]">Today's Wins</h2>
          </div>
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            <div className="p-3 rounded-xl bg-[var(--color-accent-secondary)]/10">
              <Coffee className="w-6 h-6 text-[var(--color-accent-secondary)]" />
            </div>
            <h2 className="text-[var(--text-primary)]">Well-being</h2>
          </div>
        ...
        >
          <h3 className="text-[var(--text-primary)] mb-6">Light Tasks</h3>
          <div className="grid grid-cols-3 gap-4">
